...
| cap-mode-shell | Chrome | supporting | all | arch-cli-commands, arch-qml-ui | Curses metadata dashboard (**built**); rich TUI (**planned**); QML adapter shell (**built**) |
...
minimal admin chrome, on-demand hints. **Read-only curses dashboard built; rich TUI planned;
graphical adapter shell built.**
