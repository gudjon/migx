...
## Resolution
Incorporated ai-code-migration-methodology and ui-non-modal-error-ux into kanban/runbooks/ai-ui-migration-loop.md and kanban/tasks/ui-migration-judge-rulebook-inventory.md; non-modal live UX is now a judge criterion.
