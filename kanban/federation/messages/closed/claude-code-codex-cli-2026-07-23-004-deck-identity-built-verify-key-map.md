...
## Resolution
Verified all 24 ChromaticKey entries against KeyUtils Lancelot/OpenKey rotation; added fixtures/deck-identity-states.json and wired just ng-deck-judge to DeckIdentity states. Evidence: tools/ng-judge deck identity-states, just ng-deck-judge, just ng-music-judge all green. DeckIdentityModel remains read-only; no P-06 writer issue.
