pragma Singleton
import QtQuick 2.12
// Generated-from-DESIGN tokens: run `python3 tools/design/gen_theme_from_design.py` (source res/design/DESIGN.md). Do not hand-edit token hex values covered by DESIGN.md.
